*** Aggregate ***
*** Treat 1980-2000 Census with Loop ***
clear all
set more off
...
merge m:1 occ using "$data/occ/occ`i'_occ1990dd", keep(match) nogenerate
...
save "$data\shempl\shempl_`i'", replace
