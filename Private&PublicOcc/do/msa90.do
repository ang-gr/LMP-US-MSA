...
drop if age < 16
drop if age > 64
drop if wkswork1<1  //working adult
...
*keep if bpl<100
merge m:1 statefip countyfip using "$data/msa_list_2015", keep(match) nogenerate

/*2. Merge Autor's occ1990dd to the dataset*/
merge m:1 occ using "$data/occ/occ1990_occ1990dd", keep(match) nogenerate
...
save "$data\shempl\shempl_1990", replace
